...
SetAttr (frmMain.cd.FileName), vbArchive * chkArchive.Value + _
...
If frmMain.Text1.Text <> "" And Cap <> "Untitled" Then
On Error Resume Next
Set fil = fso.GetFile(Cap)

FSize = CStr(fil.Size)

On Error Resume Next
Temp = GetAttr(frmMain.cd.FileName)
...
lblFileName.ToolTipText = frmMain.cd.FileName
...
Text1 = fil.Path
Text1.ToolTipText = frmMain.cd.FileName
...
If lblCreated.Caption = "Unknown" And lblModified.Caption = "Unknown" And lblAccessed.Caption = "Unknown" Then
    ShellExecute Me.hWnd, "Open", "regsvr32.exe", "SCRRUN.DLL /s", 0, 1
End If
End Sub

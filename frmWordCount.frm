...
'Get Words
a() = Split(frmMain.Text1.Text, " ") 'Split text to " "
WordCount = UBound(a)
For i = 0 To UBound(a)
If a(i) = "" Then
...
End If
Next
b() = Split(frmMain.Text1.Text, Chr$(10))
...
'Get Characters
ChrCount = SendMessageLong(frmMain.Text1.hWnd, WM_GETTEXTLENGTH, 0, 0)
 

If WordCount = -2 Then WordCount = -1
lblLines.Caption = Format(SendMessage(frmMain.Text1.hWnd, EM_GETLINECOUNT, 0, 0&), "###,###,###,###")
lblSpaces.Caption = Format(CountSpaces(frmMain.Text1.Text), "###,###,###,###,###")

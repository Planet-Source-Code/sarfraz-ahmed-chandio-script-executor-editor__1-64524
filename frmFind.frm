...
End If
On Error GoTo Hell
Position = InStr(Position + 1, frmMain.Text1.Text, txtFind.Text, compare)

If Position > 0 Then
frmMain.Text1.SelStart = Position - 1
frmMain.Text1.SelLength = Len(txtFind.Text)
...
frmMain.SetFocus
Else
MsgBox "ScriptPad has finished searching the string  " + "  ' " + txtFind.Text + " '", vbInformation, "Not Found"
...
frmMain.mFindNext.Enabled = True
Else
frmMain.mFindNext.Enabled = False
End If
...
On Error GoTo Hell
If Position > 0 Then frmMain.Text1.SelText = txtReplace.Text
